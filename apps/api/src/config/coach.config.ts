...
/**
 * M11 AI-coach proxy limits (CLAUDE.md rule 4; ADR-024). Engineering defaults
 ...
 */
const SOURCE = 'docs/adr/ADR-024-ai-coach.md (engineering default, no external source)';
