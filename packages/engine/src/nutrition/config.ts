...
export const NUTRITION_CONFIG = defineConfig({
  ...
  'activity.sedentary': { value: 1.2, unit: '× BMR', source: ACTIVITY, validated: false },
  'activity.light': { value: 1.375, unit: '× BMR', source: ACTIVITY, validated: false },
  ...
  'protein.maxGPerKg': { value: 2.2, unit: 'g per kg per day', source: `${SPEC} (Scope: "protein ≈ 1.6–2.2 g/kg/day … the upper end is often used in a deficit"), not checked against a primary source`, validated: false },
  ...
  /** The adaptive expenditure stays within ± this share of the formula estimate. */
