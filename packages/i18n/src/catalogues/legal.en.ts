...
export const legalEn = {
  ...
  'legal.action.read': 'I have read the Privacy Policy',
  'legal.action.readHint': 'Records that you read this version of the policy (it is information, not a contract)',
  'legal.status.read': 'Read (version {version})',
  'legal.status.needsReading': 'Please open and read this text to continue.',
  'legal.risk.statementsHint': 'Turn on each statement to confirm it. None is turned on for you.',
  'legal.risk.statementHint': 'Confirms this statement',
  'legal.risk.incomplete': 'Please confirm each statement to continue.',
  'legal.residence.question': 'Where do you live?',
  'legal.residence.intro': 'The texts, the emergency number and the age rules depend on the country where you live, not on your phone’s language. Please choose it.',
  'legal.residence.hint': 'Choose the country where you live',
  'legal.residence.required': 'Please choose where you live to continue.',
  'legal.residence.country.FR': 'In France',
  'legal.residence.country.GB': 'In the United Kingdom',
  'legal.residence.country.US': 'In the United States',
  'legal.residence.country.SN': 'In Senegal',
  'legal.residence.country.CI': 'In Côte d’Ivoire',
  'legal.residence.country.ZZ': 'In another country',
  ...
  'legal.exerciseRisk.v1.risk': 'I understand that exercise is good for most people but carries risks, including soreness, injury and, rarely, serious heart problems.',
  'legal.exerciseRisk.v1.stop': 'I will stop at once and seek medical help if I feel chest pain or pressure, faintness, much more breathlessness than the effort explains, a racing or irregular heartbeat, sudden numbness or weakness, face drooping or trouble speaking, a sudden severe headache or a sudden change of vision.',
  ...
  'legal.exerciseRisk.v1.honest': 'I answered the health questions honestly, and I will update them if my health changes.',
  'legal.exerciseRisk.v1.rights': 'This acknowledgment does not limit your legal rights.',
  'legal.exerciseRisk.v1.control': 'I know that I decide: I can skip, change or stop any exercise at any time.',
