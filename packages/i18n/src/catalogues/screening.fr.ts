...
export const screeningFr: Record<keyof typeof screeningEn, string> = {
  ...
  'screening.question.chest_discomfort': 'Au cours des {months} derniers mois, avez-vous ressenti une douleur, une pression ou une oppression dans la poitrine, en activité ou au repos ?',
