...
/**
 * M11 AI coach contracts (docs/specs/M11-ai-coach.md, ADR-024).
 *
 ...
 */
const BOUNDS_SOURCE = 'docs/adr/ADR-024-ai-coach.md (engineering default: bounds of a request, not a training value)';
