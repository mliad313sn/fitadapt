...
| [ADR-024](ADR-024-ai-coach.md) | AI coach: deterministic safety pre-screen first, engine-only tools with audits, server-side Claude proxy with the M20 preamble, runtime output guard, offline coach, evals with misbehaving models | M11 |
